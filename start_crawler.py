...
if __name__ == '__main__':
    ...
    t2 = threadPool.submit(allocate_check_task, proxy_queue, proxy_waitsave_queue, valid_proxy, invalid_proxy)
    # 从存储队列中取数据并入库
    t3 = threadPool.submit(data_store, proxy_waitsave_queue)
